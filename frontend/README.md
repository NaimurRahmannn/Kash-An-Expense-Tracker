...
Frontend Part 7 completed:

- Edit Expense page connected to `GET /expenses/:id`
- Update Expense flow connected to `PUT /expenses/:id`
- Edit form loads existing expense data
